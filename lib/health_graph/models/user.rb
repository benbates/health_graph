module HealthGraph
  class User
    ...
    def fitness_activity uri
      HealthGraph::FitnessActivity.new self.access_token, uri
    end

    def fitness_activity_summary uri
      HealthGraph::FitnessActivitySummary.new self.access_token, uri
    end
